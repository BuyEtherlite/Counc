<?php $__env->startSection('title', 'Install Council ERP System'); ?>
            ...
            <div class="card-body p-5">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <?php if(!collect($requirements)->every('status')): ?>
                            ...
                            <div class="collapse" id="deployment-help">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="small mb-0">
                                            <strong>Need detailed help?</strong> See <a href="<?php echo e(asset('DEPLOYMENT.md')); ?>" target="_blank">DEPLOYMENT.md</a> 
                        ...
                        <div class="requirements-list">
                            <?php $__currentLoopData = $requirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="requirement-item d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span class="badge <?php echo e($req['status'] ? 'bg-success' : 'bg-danger'); ?>">
                                        <?php echo e($req['status'] ? '✓' : '✗'); ?> <?php echo e($req['current']); ?>
                        ...
                        <div class="permissions-list">
                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="permission-item d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span class="badge <?php echo e($perm['status'] ? 'bg-success' : 'bg-danger'); ?>">
                                        <?php echo e($perm['status'] ? '✓ Writable' : '✗ Not Writable'); ?>
                ...
                <form method="POST" action="<?php echo e(route('install.store')); ?>" id="installForm" <?php echo e(!$allRequirementsMet ? 'style=display:none' : ''); ?>>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="site_name" name="site_name" 
                                   value="<?php echo e(old('site_name', 'City Council ERP')); ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="site_description" class="form-label">Site Description</label>
                            <input type="text" class="form-control" id="site_description" name="site_description" 
                                   value="<?php echo e(old('site_description', 'Municipal ERP Management System')); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="db_host" name="db_host" 
                                   value="<?php echo e(old('db_host', '127.0.0.1')); ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="db_port" class="form-label">Database Port *</label>
                            <input type="number" class="form-control" id="db_port" name="db_port" 
                                   value="<?php echo e(old('db_port', '3306')); ?>" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="db_database" name="db_database" 
                                   value="<?php echo e(old('db_database', 'council_erp')); ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="db_username" class="form-label">Database Username *</label>
                            <input type="text" class="form-control" id="db_username" name="db_username" 
                                   value="<?php echo e(old('db_username', 'root')); ?>" required>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="admin_name" name="admin_name" 
                                   value="<?php echo e(old('admin_name')); ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="admin_email" class="form-label">Admin Email *</label>
                            <input type="email" class="form-control" id="admin_email" name="admin_email" 
                                   value="<?php echo e(old('admin_email')); ?>" required>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="council_name" name="council_name" 
                                   value="<?php echo e(old('council_name')); ?>" required>
                        </div>
                        <div class="col-md-12">
                            <label for="council_address" class="form-label">Council Address *</label>
                            <textarea class="form-control" id="council_address" name="council_address" rows="3" required><?php echo e(old('council_address')); ?></textarea>
                        </div>
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="council_contact" name="council_contact" rows="2" 
                                      placeholder="Phone, Email, Website" required><?php echo e(old('council_contact')); ?></textarea>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    testDbBtn.addEventListener('click', function() {
        ...
        // Make AJAX request
        fetch('<?php echo e(route("install.test-database")); ?>', {
            method: 'POST',
            headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.install', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/install/index.blade.php ENDPATH**/ ?>